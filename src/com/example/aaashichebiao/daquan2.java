...
public class daquan2 extends ADbaseActivity
{
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        position = getIntent().getIntExtra("int1", 0);
        imageView2 = (ImageView)findViewById(0x7f08000f);
        textView3 = (TextView)findViewById(0x7f080010);
        button8 = (Button)findViewById(0x7f080012);
        imageView2.setImageResource(imageIDs[position].intValue());
        textView3.setText(name[position]);
